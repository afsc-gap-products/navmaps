...
graph TD
  ...
  D["Are there GPS fixes before and after the new event time that are within XX seconds of the event time?"]--> |Yes| E["Assign location by interpolation."]
  ...
  subgraph User steps
    ...
    G["Are GPS data available from a backup data source?"]--> |No| I["Manually enter coordinates from paper forms."]
  end
